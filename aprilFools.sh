...
#  call this from a user's .bash_profile and watch them squirm
#  spelling and grammer are purposely mangled for effect; there's also a clue in the output that this isn't a hack
#
